...
extern int Init (unsigned long adr, unsigned long clk, unsigned long fnc); // Initialize Flash                                                                   
extern int UnInit (unsigned long fnc);  // De-initialize Flash

extern int BlankCheck (unsigned long adr,unsigned long sz,unsigned char pat); // Blank Check                                                                     
